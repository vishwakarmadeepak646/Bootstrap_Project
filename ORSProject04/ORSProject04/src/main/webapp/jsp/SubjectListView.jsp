  ...
  <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <div class="card-header text-white border-0 py-3 px-4 d-flex justify-content-between align-items-center"
      ...
      <div class="d-flex gap-2">
        ...
        <a href="<%=ORSView.SUBJECT_REPORT_CTL%>?type=doc" target="_blank" class="btn btn-sm btn-info fw-semibold">
        ...
        <table class="table table-hover align-middle mb-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="SubjectCtl?id=<%=bean.getId()%>" class="btn btn-sm btn-outline-primary">
