...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.SubjectBean" scope="request"></jsp:useBean>
      ...
      <form action="<%=ORSView.SUBJECT_CTL%>" method="POST">
        ...
        <div class="mb-4">
          ...
          <select name="courseId" class="form-select">
            ...
            %>
            <option value="<%=course.getId()%>" <%=(bean.getCourseId() == course.getId()) ? "selected" : ""%>>
              <%=course.getName()%>
            </option>
            <%
                }
        ...
        <div class="d-flex gap-2 pt-2 border-top">
          ...
          <% } %>
          <a href="<%=ORSView.SUBJECT_LIST_CTL%>" class="btn btn-secondary ms-auto">
